...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('person_person', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='a7e3ad4a-9678-40ed-a32d-f2a6c82409a6', unique=True, max_length=36, primary_key=True, db_index=True)),
        ...
        db.create_table('person_personname', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='d8ab85b2-c58c-4279-8a90-77bd7193a65b', unique=True, max_length=36, primary_key=True, db_index=True)),
        ...
        db.create_table('person_relationtype', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='42e4bde2-3545-4061-93dc-a9dba6ce1d7f', unique=True, max_length=36, primary_key=True, db_index=True)),
        ...
        db.create_table('person_relation', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='3e1d499e-9f79-4267-ad6b-c9484c114b54', unique=True, max_length=36, primary_key=True, db_index=True)),
        ...
        db.create_table('person_contacttype', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='9cf9f2c1-2022-4552-94f7-87b56f49c65b', unique=True, max_length=36, primary_key=True, db_index=True)),
        ...
        db.create_table('person_contact', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='0a082d26-5629-44fb-bf98-591a39463afa', unique=True, max_length=36, primary_key=True, db_index=True)),
            ...
            ('void_reason', self.gf('django.db.models.fields.CharField')(max_length=765, blank=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Person'], null=True, blank=True)),
            ('contact_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.ContactType'], null=True, blank=True)),
        ...
        db.create_table('person_identifiertype', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='8c73096c-9a27-4859-b340-c69f4187afb8', unique=True, max_length=36, primary_key=True, db_index=True)),
        ...
        db.create_table('person_identifier', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='db9dc799-877b-4ce2-84bf-741784f2f9fd', unique=True, max_length=36, primary_key=True, db_index=True)),
    ...
    models = {
        ...
        'location.address': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ae572894-5cf8-4d52-90c6-891faa0ae52f'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
        ...
        'person.contact': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2170a354-5dbb-4db1-b8bd-96fe3329b1ab'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
            'void_reason': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'voided': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'person.contacttype': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2af3f21e-11af-4960-bf57-f5d4a3ed052d'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
            'void_reason': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'voided': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'person.identifier': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'77b666bb-955d-4a74-9ecf-9e9f56ae29a7'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
            'void_reason': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'voided': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'person.identifiertype': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'46293ae6-8720-4f7c-8fca-f97e5698d50a'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
            'void_reason': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'voided': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'person.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b8513a30-2613-4cba-937c-ab2527becd49'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
            'void_reason': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'voided': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'person.personname': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d551454b-5a27-4330-b6f1-ad0e984be61b'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
            'void_reason': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'voided': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'person.relation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fca17f99-d15e-494f-9ca4-0204e9c690a6'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
            'void_reason': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'voided': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'person.relationtype': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'57c6c7be-33fc-409f-bfb4-2bf69b0ae91e'", 'unique': 'True', 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
            'void_reason': ('django.db.models.fields.CharField', [], {'max_length': '765', 'blank': 'True'}),
            'voided': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
